...
run_stage_model = BashOperator(
    ...
    bash_command='/home/airflow/dbt-env/bin/dbt run --model tag:"DIMENSION" --project-dir /home/airflow/dbt-code/ --profiles-dir /home/airflow/.dbt/ --profile Netflix --target dev',
    dag=dag
)
